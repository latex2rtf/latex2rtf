...
$$
where $p'$ and $\rho'$ are the variations and $p'\ll p_0$, $\rho'\ll\rho_0$.
...
This equation must be supplied with appropriate boundary conditions,
...
$$
The closed form solution for the Green's function for the infinite domain is
$$
